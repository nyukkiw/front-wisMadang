  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <div className="w-full max-w-md rounded-2xl bg-[#F4EAE1] p-6 shadow-2xl">
        ...
        {/* Nomor pesanan */}
        <div className="mt-5 rounded-xl bg-[#FCF9F6] p-4 text-center">
          <p className="text-xs text-gray-500">Nomor Pesanan</p>

          <p className="mt-1 font-mono text-lg font-bold text-[#2C2520]">{orderNumber}</p>
        </div>
        ...
        <div className="mt-5 border-t border-[#dce8e2] pt-4">
          ...
          <div className="mt-3 flex justify-between border-t border-[#dce8e2] pt-3">
            <span className="font-bold text-[#2C2520]">Total</span>

            <span className="font-bold text-[#2C2520]">Rp {total.toLocaleString("id-ID")}</span>
          </div>
        </div>

        {/* Metode pembayaran */}
        <div className="mt-4 flex justify-between rounded-xl bg-[#FCF9F6] p-3 text-sm">
